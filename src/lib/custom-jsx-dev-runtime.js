import * as originalDevRuntime from '../../node_modules/react/jsx-dev-runtime.js';
...
export function jsxDEV(type, props, key, isStaticChildren, source, self) {
  return originalDevRuntime.jsxDEV(type, translateProps(props), key, isStaticChildren, source, self);
}

export const Fragment = originalDevRuntime.Fragment;
