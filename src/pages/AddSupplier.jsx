...
import { Save, User, Phone, MapPin, Truck } from 'lucide-react';
...
const AddSupplier = () => {
  ...
  return (
    <div className="animate-fade-in" style={{ background: '#F8FAFC', minHeight: '100vh', paddingTop: 'calc(var(--safe-top) + 88px)', paddingBottom: '40px' }}>
      <PageHeader title="Add Supplier" showBack={true} />
      ...
      <form onSubmit={handleSubmit} style={{ padding: '0 20px', marginTop: '15px' }}>
        <div className="glass-card animate-slide-up" style={{ padding: '24px', background: 'white', borderRadius: '28px', boxShadow: '0 15px 35px rgba(0,0,0,0.05)', marginBottom: '24px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: '800', color: '#64748B', marginBottom: '8px', textTransform: 'uppercase' }}>Supplier Name</label>
              <div style={{ position: 'relative' }}>
                ...
                <input 
                  type="text" 
                  required
                  placeholder="e.g. Kisan Feed Agency"
                  value={formData.name}
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input 
                  type="text" 
                  placeholder="e.g. New Market, Gwalior"
