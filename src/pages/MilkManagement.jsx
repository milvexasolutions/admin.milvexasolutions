...
const MilkManagement = () => {
  ...
  return (
    <div className="animate-fade-in" style={{ background: '#F8FAFC', minHeight: '100vh', paddingBottom: '100px', paddingTop: 'calc(var(--safe-top) + 80px)' }}>
      <PageHeader title="Milk Records" showBack={true} />
      ...
      <div style={{ padding: '24px 20px' }}>
        ...
        <div style={{ 
          ...
          <h3 style={{ margin: '0 0 4px', fontSize: '18px', fontWeight: '800' }}>Quick Analytics</h3>
          <p style={{ margin: 0, fontSize: '13px', color: 'rgba(255,255,255,0.7)', fontWeight: '500' }}>Track your daily milk production effortlessly.</p>
        </div>
      </div>
    </div>
  );
